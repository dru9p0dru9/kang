...
class KangMod(loader.Module):
    ...
    strings = {
        "name": "Kang",
        "silent_mode_cfg_doc": "Если этот параметр отключен, ваш пользовательский бот будет редактировать сообщение на каждом шаге (недавние изменения) (вкл / выкл)",
        "pack_name_cfg_doc": "Userbot pack name.\n%username% - your username\n%packNumber% - number of pack.",
        "preparing_msg": "<code>Готовимся...</code>",
        "unsupported_err": "<b>Такого не существует</b>",
        "reply_err": "<b>Ответь на фото/стикер/докумен</b>",
        "gettingType_msg": "<code>Получение типа стикера...</code>",
        "image_kanging_msg": "<code> Наклейка с изображением друга...</code>",
        "animated_kanging_msg": "<code>Забрасываем в пак...</code>",
        "pack_notExist": "Стикер пак doesn\'t exist, делая новый...",
        "switching_msg": "<code>Переключение {} из-за недостатка места...</code>",
        "added_to_different_msg": "Стикер добавлен в другой пакет!" +
            "Этот пакет недавно создан! Ваш пакет может быть найден <a href=\"{}\">here</a> \n " +  # noqa: E131
            "<b>Это сообщение должно быть уничтожено через 5 секунд</b>",
        "added_msg": "Стикер добавлен! Ваш пакет может быть найден <a href=\"{}\">here</a> \n" +
            "<b>Это сообщение должно быть уничтожено через 5 секунд.</b>",
    }
